	...
	<div class="main-center">
		...
		<div class="card" data-state="#about">
			...
			<div class="card-main">
				...
				<div class="card-section" id="feed">
					<div class="card-content">
						<c:forEach items="${myFeedList}" var="myfeed">
							<form action="#">
								<a href="detailFeed.jsp" class="feed-move">
									<table>
										<!-- 챌린지 제목 -->
										<tr>
											<td colspan="2">
												<h2>${myfeed.chal_title}</h2>
											</td>
										</tr>
										<!-- 피드 이미지 -->
										<tr class="feed-img-td">
											<td colspan="2"><img class="feed-img"
												src="${myfeed.img}" alt="Feed Image"></td>
										</tr>
									</table>
								</a>
							</form>
				...
				<div class="card-buttons">
					<button class="is-active" data-section="#feed">게시글</button>
